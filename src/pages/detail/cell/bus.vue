    ...
    <view class="busline--body">
      <view class="busline--body--stops">
        <view class="stop departure_stop">
          ...
          <text v-if="entrance.name" class="entrance">{{entrance.name}} Arrived </text>
        </view>
        <view class="more">
          <text class="text">Though {{busline.via_num}} station</text>
          <text class="dot">·</text>
        ...
        <view class="stop arrival_stop">
          ...
          <text v-if="exit.name" class="exit">{{exit.name}} Departed</text>
        </view>
      </view>
    </view>
  </view>
